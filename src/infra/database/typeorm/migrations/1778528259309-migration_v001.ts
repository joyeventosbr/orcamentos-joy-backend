...
export class MigrationV0011778528259309 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "tb_users" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "email" character varying NOT NULL, "password" character varying NOT NULL, "role" smallint NOT NULL DEFAULT '1', "created_at" TIMESTAMP NOT NULL, "cd_empresa" character varying, "updated_at" TIMESTAMP, CONSTRAINT "UQ_142ce3112f446974f1c96a5d3ff" UNIQUE ("email"), CONSTRAINT "PK_a2c23e0679749c22ffa6c2be910" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "tb_companies" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL, "updated_at" TIMESTAMP, CONSTRAINT "PK_edb1512762c7bc2e16aa57d588d" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "tb_events" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL, "updated_at" TIMESTAMP, CONSTRAINT "PK_76ea32aacaec2ebd650509d307a" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "tb_budgets" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "client" character varying NOT NULL, "job" character varying NOT NULL, "deadline" character varying NOT NULL, "location" character varying NOT NULL, "event_date" character varying NOT NULL, "participants" integer NOT NULL, "created_at" TIMESTAMP NOT NULL, "updated_at" TIMESTAMP, CONSTRAINT "PK_d06d41390f17faa1ed047e92896" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "tb_companies_events" ("company_id" uuid NOT NULL, "event_id" uuid NOT NULL, CONSTRAINT "PK_e0c22799554b2f4b52cbed8ad07" PRIMARY KEY ("company_id", "event_id"))`);
        await queryRunner.query(`CREATE UNIQUE INDEX "UQ_tb_companies_events_event_id" ON "tb_companies_events" ("event_id") `);
        await queryRunner.query(`CREATE TABLE "tb_events_budgets" ("event_id" uuid NOT NULL, "budget_id" uuid NOT NULL, CONSTRAINT "PK_5ad759ab7079d42aba1bb130845" PRIMARY KEY ("event_id", "budget_id"))`);
        await queryRunner.query(`CREATE UNIQUE INDEX "UQ_tb_events_budgets_budget_id" ON "tb_events_budgets" ("budget_id") `);
        ...
        await queryRunner.query(`ALTER TABLE "tb_companies_events" ADD CONSTRAINT "FK_e9c0465ed581318c51e743c6c9c" FOREIGN KEY ("company_id") REFERENCES "tb_companies"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "tb_companies_events" ADD CONSTRAINT "FK_25a3ac716dda1e8971d6a970db4" FOREIGN KEY ("event_id") REFERENCES "tb_events"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "tb_events_budgets" ADD CONSTRAINT "FK_0aaa0a58ff868870ea850748b84" FOREIGN KEY ("event_id") REFERENCES "tb_events"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "tb_events_budgets" ADD CONSTRAINT "FK_74b3e2e1ff50d930c6a5fb4d05a" FOREIGN KEY ("budget_id") REFERENCES "tb_budgets"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "tb_events_budgets" DROP CONSTRAINT "FK_74b3e2e1ff50d930c6a5fb4d05a"`);
        await queryRunner.query(`ALTER TABLE "tb_events_budgets" DROP CONSTRAINT "FK_0aaa0a58ff868870ea850748b84"`);
        await queryRunner.query(`ALTER TABLE "tb_companies_events" DROP CONSTRAINT "FK_25a3ac716dda1e8971d6a970db4"`);
        await queryRunner.query(`ALTER TABLE "tb_companies_events" DROP CONSTRAINT "FK_e9c0465ed581318c51e743c6c9c"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."UQ_tb_events_budgets_budget_id"`);
        await queryRunner.query(`DROP TABLE "tb_events_budgets"`);
        await queryRunner.query(`DROP INDEX "public"."UQ_tb_companies_events_event_id"`);
        await queryRunner.query(`DROP TABLE "tb_companies_events"`);
        ...
        await queryRunner.query(`DROP TABLE "tb_events"`);
