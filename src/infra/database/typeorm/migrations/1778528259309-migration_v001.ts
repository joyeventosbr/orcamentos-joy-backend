...
export class MigrationV0011778528259309 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "tb_budget_categories" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "code" character varying NOT NULL, "order" integer NOT NULL, CONSTRAINT "PK_7ab2f6419c7a8281a911f09d525" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "tb_customers_folders" ("customer_id" uuid NOT NULL, "folder_id" uuid NOT NULL, CONSTRAINT "PK_e0c22799554b2f4b52cbed8ad07" PRIMARY KEY ("customer_id", "folder_id"))`,
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX "UQ_tb_customers_folders_folder_id" ON "tb_customers_folders" ("folder_id") `,
    );
    await queryRunner.query(
      `CREATE TABLE "tb_folders_budgets" ("folder_id" uuid NOT NULL, "budget_id" uuid NOT NULL, CONSTRAINT "PK_5ad759ab7079d42aba1bb130845" PRIMARY KEY ("folder_id", "budget_id"))`,
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX "UQ_tb_folders_budgets_budget_id" ON "tb_folders_budgets" ("budget_id") `,
    );
    await queryRunner.query(
      `ALTER TABLE "tb_budgets" ADD CONSTRAINT "FK_tb_budgets_customer_id" FOREIGN KEY ("customer_id") REFERENCES "tb_customers"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "tb_budget_lines" ADD CONSTRAINT "FK_f35d88c3467fd7a1478ced1ff85" FOREIGN KEY ("category_id") REFERENCES "tb_budget_categories"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "tb_customers_folders" ADD CONSTRAINT "FK_e9c0465ed581318c51e743c6c9c" FOREIGN KEY ("customer_id") REFERENCES "tb_customers"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "tb_customers_folders" ADD CONSTRAINT "FK_25a3ac716dda1e8971d6a970db4" FOREIGN KEY ("folder_id") REFERENCES "tb_folders"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "tb_folders_budgets" ADD CONSTRAINT "FK_0aaa0a58ff868870ea850748b84" FOREIGN KEY ("folder_id") REFERENCES "tb_folders"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "tb_folders_budgets" ADD CONSTRAINT "FK_74b3e2e1ff50d930c6a5fb4d05a" FOREIGN KEY ("budget_id") REFERENCES "tb_budgets"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "tb_folders_budgets" DROP CONSTRAINT "FK_74b3e2e1ff50d930c6a5fb4d05a"`,
    );
    await queryRunner.query(
      `ALTER TABLE "tb_folders_budgets" DROP CONSTRAINT "FK_0aaa0a58ff868870ea850748b84"`,
    );
    await queryRunner.query(
      `ALTER TABLE "tb_customers_folders" DROP CONSTRAINT "FK_25a3ac716dda1e8971d6a970db4"`,
    );
    await queryRunner.query(
      `ALTER TABLE "tb_customers_folders" DROP CONSTRAINT "FK_e9c0465ed581318c51e743c6c9c"`,
    );
    await queryRunner.query(
      `ALTER TABLE "tb_budget_lines" DROP CONSTRAINT "FK_3e9f8fa934096c95bf4bed23322"`,
    );
    await queryRunner.query(
      `ALTER TABLE "tb_budget_lines" DROP CONSTRAINT "FK_f35d88c3467fd7a1478ced1ff85"`,
    );
    await queryRunner.query(
      `ALTER TABLE "tb_budget_lines" DROP CONSTRAINT "FK_1c385d13fa74d0875a1653c0794"`,
    );
    await queryRunner.query(
      `ALTER TABLE "tb_budgets" DROP CONSTRAINT "FK_tb_budgets_customer_id"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."UQ_tb_folders_budgets_budget_id"`,
    );
    await queryRunner.query(`DROP TABLE "tb_folders_budgets"`);
    await queryRunner.query(
      `DROP INDEX "public"."UQ_tb_customers_folders_folder_id"`,
    );
