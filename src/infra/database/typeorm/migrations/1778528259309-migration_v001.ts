...
export class MigrationV0011778528259309 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "tb_budgets" ADD CONSTRAINT "FK_tb_budgets_customer_id" FOREIGN KEY ("customer_id") REFERENCES "tb_customers"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "tb_budgets" DROP CONSTRAINT "FK_tb_budgets_customer_id"`);
